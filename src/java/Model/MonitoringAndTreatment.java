...
public class MonitoringAndTreatment {
    ...
    public MonitoringAndTreatment(String ID, String monitorDate, double weight, int bloodPressure, int respiratoryRate, String medicalOrder, 
            String performDate, String orderPerform, String patientID, String patientName, String employeeID, String employeeName) {
        this.ID = ID;
